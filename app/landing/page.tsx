      ...
      <section className="relative bg-gradient-to-br from-purple-50 via-white to-blue-50 py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-5xl mx-auto mb-12">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-gray-900 mb-6 leading-none">
            ...
            <p className="text-2xl md:text-3xl text-gray-700 mb-4 leading-relaxed font-medium">
              AI-powered music mixing that creates professional-quality content in under 5 minutes
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Unlimited AI music generation</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                    <span className="text-gray-700">Unlimited AI thumbnail generation</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: 'Can I edit the mix order after AI sequencing?',
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold text-white">InfiniteMix</span>
            </div>

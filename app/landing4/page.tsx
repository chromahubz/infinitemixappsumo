...
export default function Landing4() {
  ...
  return (
    <div style={{ fontFamily: 'Roboto, system-ui, -apple-system, sans-serif' }} className="min-h-screen bg-gray-50">
      {/* Material Design Navigation */}
      <nav className="fixed top-0 w-full bg-white shadow-md z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="text-2xl font-bold text-indigo-600">InfiniteMix</Link>
            <div className="hidden md:flex space-x-8">
              <Link href="/#features" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">Features</Link>
              <Link href="/#how-it-works" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">How It Works</Link>
              <Link href="/#testimonials" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">Testimonials</Link>
              <Link href="/#faq" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">FAQ</Link>
            </div>
            <Link href="/software" className="px-6 py-2 bg-indigo-600 text-white font-medium rounded hover:bg-indigo-700 transition-all shadow-lg hover:shadow-xl">
              Get Started
            </Link>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-indigo-50 to-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-block px-4 py-2 bg-pink-100 text-pink-700 rounded-full text-sm font-medium mb-6 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/software" className="px-8 py-4 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-all shadow-lg hover:shadow-xl">
              Start Creating Free
            </Link>
            <Link href="#demo" className="px-8 py-4 bg-white text-indigo-600 font-medium rounded-lg border-2 border-indigo-600 hover:bg-indigo-50 transition-all shadow-md">
              Watch Demo
            </Link>
          </div>
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-center">
            <div className="bg-white rounded-lg shadow-md p-6 min-w-[140px]">
              <div className="text-3xl font-bold text-indigo-600">10K+</div>
              <div className="text-gray-600 mt-1">Active Users</div>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6 min-w-[140px]">
              <div className="text-3xl font-bold text-indigo-600">500K+</div>
              <div className="text-gray-600 mt-1">Mixes Created</div>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6 min-w-[140px]">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Popular Genres</h2>
            <p className="text-xl text-gray-600">Create mixes in any style. Trending genres updated daily.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {genres.map((genre, i) => (
              <div key={i} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all transform hover:-translate-y-1">
                <div className="relative h-64">
                  <img src={genre.img} alt={genre.name} className="w-full h-full object-cover" />
                  {genre.badge && (
                    <div className="absolute top-4 right-4 bg-pink-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-md">
                      {genre.badge}
                    </div>
                  )}
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-4">From Bedroom to 100K+ Views</h2>
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <div className="flex items-center justify-center gap-4">
                  <div>
                    <div className="font-bold text-gray-900">Jake Morrison</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Creating Quality Mixes Takes Forever</h2>
              ...
              <div className="mt-8">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-4">AI-Powered Mixing in Minutes</h3>
                <div className="space-y-4 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden">
              ...
              />
              <div className="p-6 bg-gradient-to-r from-indigo-50 to-pink-50">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Real Mixes, Real Results</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-lg text-gray-900 mb-2">Chill Lofi Hip Hop Mix</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-lg text-gray-900 mb-2">Deep House Vibes</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="font-bold text-lg text-gray-900 mb-2">Ambient Soundscapes</h3>
      ...
      <section id="features" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Powerful Features for Every Creator</h2>
            <p className="text-xl text-gray-600">Everything you need to create, customize, and share professional mixes</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              <div key={i} className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-all transform hover:-translate-y-1">
                <div className="inline-flex p-4 bg-gradient-to-br from-indigo-100 to-pink-100 text-indigo-600 rounded-lg mb-4">
                  {feature.icon}
                </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Creators Choose InfiniteMix</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {benefits.map((benefit, i) => (
              <div key={i} className="bg-white rounded-lg shadow-lg p-8 border-l-4 border-indigo-600 hover:shadow-xl transition-shadow">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {activeTab === 'ai' && (
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 shadow-md">1</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Choose Your Genre</h3>
                <p className="text-gray-600">Select from Lofi, House, Techno, Ambient, Trap, and dozens more genres.</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 shadow-md">2</div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 shadow-md">3</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Download or Share</h3>
          ...
          {activeTab === 'manual' && (
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 shadow-md">1</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Search & Add Tracks</h3>
                <p className="text-gray-600">Browse our library of millions of tracks. Add favorites to your mix queue.</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 shadow-md">2</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Customize Everything</h3>
                <p className="text-gray-600">Adjust transitions, EQ, effects, and timing. Full creative control at your fingertips.</p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
                <div className="w-12 h-12 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl font-bold mb-6 shadow-md">3</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Perfect & Export</h3>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Built for Creators Like You</h2>
            <p className="text-xl text-gray-600">Whatever your goal, InfiniteMix helps you achieve it</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {useCases.map((useCase, i) => (
              <div key={i} className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-all">
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-gradient-to-br from-indigo-100 to-pink-100 text-indigo-600 rounded-lg flex-shrink-0">
                    {useCase.icon}
                  </div>
                  <div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-indigo-600 to-pink-600 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90">Trusted by creators worldwide</p>
          </div>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg shadow-xl p-8 text-center hover:bg-white/20 transition-all">
              <div className="text-5xl font-bold mb-2">10,000+</div>
              <div className="text-lg opacity-90">Active Creators</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg shadow-xl p-8 text-center hover:bg-white/20 transition-all">
              <div className="text-5xl font-bold mb-2">500,000+</div>
              <div className="text-lg opacity-90">Mixes Generated</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg shadow-xl p-8 text-center hover:bg-white/20 transition-all">
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                >
                  ...
                  <span className="text-2xl text-indigo-600 flex-shrink-0 ml-4">
                    {expandedFaq === i ? '−' : '+'}
                  </span>
                </button>
                {expandedFaq === i && (
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-bold mb-6">Ready to Create Your First Mix?</h2>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-white font-bold text-lg mb-4">InfiniteMix</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/software" className="hover:text-white transition-colors">Pricing</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:contact@unitar.app" className="hover:text-white transition-colors">contact@unitar.app</a></li>
              </ul>
            </div>
          </div>
